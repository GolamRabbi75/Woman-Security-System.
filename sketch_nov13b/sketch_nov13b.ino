...
#define e_s2 A4 //echo pin
#define t_s2 A5 //Trigger pin
...
if(person>0){digitalWrite(relay,HIGH); lcd.print("On ");Serial.print("On");}
else{digitalWrite(relay,LOW); lcd.print("Off");Serial.print("Off");}
}
